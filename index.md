<div style="padding:20px;">
  ...
  <a href="https://public.tableau.com/app/profile/ben.zhang1936/viz/PatientsTop-RatedCareExperiences/HCAHPSDashboard?publish=yes">
    <img src="https://raw.githubusercontent.com/Benjamin2009/Benjamin2009.github.io/master/images/Patients%20Top-Rated%20Care%20Experiences.png" style="display:block; margin:auto; width:103.5%; max-width:920px; border-radius:10px;" alt="Care Experience Dashboard" />
  </a>
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Tableau | Data Visualization</p>
  ...
  <a href="https://nbviewer.org/github/Benjamin2009/Predicting-Emergency-Hospital-Admissions/blob/main/Hospital_Admission_Football_Injury_2019-2023.ipynb">
    <img src="https://raw.githubusercontent.com/Benjamin2009/Predicting-Emergency-Hospital-Admissions/main/ER_Football_Injury.png" style="display:block; margin:auto; width:103.5%; max-width:920px; border-radius:10px;" alt="ER_Football_Injury" />
  </a>
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Pandas | NumPy | Time Series Analysis | Machine Learning</p>
  ...
  <a href="https://nbviewer.org/github/Benjamin2009/anxiety-depression-covid/blob/main/Anxiety%20and%20Depression%20in%20American%20Households%20during%20COVID-19.ipynb">
    <img src="https://raw.githubusercontent.com/Benjamin2009/anxiety-depression-covid/main/anxiety-depression-covid-19.jpeg" style="display:block; margin:auto; width:103.5%; max-width:920px; border-radius:10px;" alt="Anxiety and Depression Project Image" />
  </a>
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Pandas | Matplotlib | Data Analysis | Survey Data</p>
  ...
  <a href="https://nbviewer.org/github/Benjamin2009/Drug-Review-Sentiment-Analysis/blob/main/Drug_Review_Sentiment_Analysis.ipynb">
    <img src="https://raw.githubusercontent.com/Benjamin2009/Drug-Review-Sentiment-Analysis/main/Drug-Review.png" style="display:block; margin:auto; width:103.5%; max-width:920px; border-radius:10px;" alt="Sentiment Analysis Project Image" />
  </a>
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">NumPy | Pandas | NLP | Sklearn | Logistic Regression</p>
  ...
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Keras | TensorFlow | Convolutional Neural Networks</p>
  ...
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">TensorFlow | Convolutional Neural Networks | Image Processing</p>
  ...
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Clustering | Unsupervised Learning | Pandas | Matplotlib</p>
  ...
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">MRI Data | Random Forest | Data Preprocessing</p>
  ...
  <a href="https://nbviewer.org/github/Benjamin2009/News-Articles-Topic-Modeling/blob/main/News-Modeling.ipynb#table">
    <img src="https://raw.githubusercontent.com/Benjamin2009/News-Articles-Topic-Modeling/main/news%20articles.jpg" style="display:block; margin:auto; width:103.5%; max-width:920px; border-radius:10px;" alt="News Articles Project Image" />
  </a>
  <p style="text-align:center; font-size:14px; margin-top:10px; color: #555;">Natural Language Processing | Topic Modeling | Latent Dirichlet Allocation (LDA)</p>
